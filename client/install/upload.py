...
# upload
oss2.resumable_upload(bucket, "Software/zm/courses/version.meta", "version.meta", multipart_threshold=100*1024)
print("upload file [version.meta] to ALIYUN oss")
oss2.resumable_upload(bucket, "Software/zm/courses/cet4.pck", "cet4.pck", multipart_threshold=100*1024)
